...
\toprule
\textbf{Question} & \textbf{Criterion} & \textbf{Human 1} & \textbf{Human 2} & \textbf{Disagreement category} & \textbf{Audit summary} \\
\midrule
...
\begin{table}[H]
\centering
\caption{Profile-specific within-representation score separation under distracted materials.}
...
\begin{figure}[p]
    ...
    \caption{Distracted-material PDB--performance profiles across multidimensional Study 3 learners.}
