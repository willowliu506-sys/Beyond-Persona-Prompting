...
% \end{figure}
\vspace{1.2cm}
\noindent\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}p{0.43\textwidth}p{0.43\textwidth}@{}}
\underline{\makebox[\linewidth]{}} &
\underline{\makebox[\linewidth]{September 1, 2026}} \\
...
\begin{sortedlist} %sort alphabetically
  \sortitem{ACU:     Atomic Content Unit}
