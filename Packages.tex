...
%% Sorted list
% Entries are maintained in alphabetical order in Report.tex. This preserves
% the template's unbulleted list appearance without a runtime sorting package.
\newcommand{\sortitem}[1]{\item[] #1}
\newenvironment{sortedlist}{\begin{itemize}}{\end{itemize}}
%% 
